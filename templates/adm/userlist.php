                    ...
                    <div class="card-body card-form">
						<?php if($loginsystem->auditRight('user_add')){ ?>
                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    <?php if(!empty($webmaster_confirm)){ ?>
                                        <a class="btn btn-secondary float-left" href="?p=userlist"><i class="fa fa-times"></i> Abbrechen</a>
                                        <button class="btn btn-warning float-right" type="submit"><i class="fa fa-check"></i> Ich habe verstanden &mdash; Trotzdem anlegen</button>
                                    <?php } else { ?>
                    ...
                    <div class="card-body card-form">
                        ...
                        <?php echo csrf_field(); ?>
                           ...
                           <div class="form-group">
                                <?php if(!empty($webmaster_confirm)){ ?>
                                    <a class="btn btn-secondary float-left" href="?p=userlist"><i class="fa fa-times"></i> Abbrechen</a>
                                    <button class="btn btn-warning float-right" type="submit"><i class="fa fa-check"></i> Ich habe verstanden &mdash; Trotzdem speichern</button>
                                <?php } else { ?>
