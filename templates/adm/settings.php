               		...
               		<div class="card-header d-flex justify-content-between align-items-center">
               			...
               			<span><?php
               				...
               				if ($_gh_version_clean !== '' && version_compare($_gh_version_clean, EASY_VERSION, '>')) {
               					echo ' <a href="?p=update" class="badge bg-warning text-dark ms-1"><i class="fa fa-arrow-up"></i> ' . htmlspecialchars($_gh_version_clean) . ' verfügbar</a>';
               				} elseif ($_gh_version !== '') {
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									...
									<input type="text" name="smtp_host" class="form-control" value="<?php echo isset($_POST['smtp_host']) ? e($_POST['smtp_host']) : $loginsystem->getMainData('smtp_host'); ?>" id="smtp_host" maxlength="128" placeholder="z.B. mail.nfsmw15.de">
								</div>
								<div class="col-sm-2">
									<label for="smtp_port">Port:</label>
									<input type="number" name="smtp_port" class="form-control" value="<?php echo isset($_POST['smtp_port']) ? e($_POST['smtp_port']) : $loginsystem->getMainData('smtp_port'); ?>" id="smtp_port" placeholder="587">
								</div>
								<div class="col-sm-3">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									...
									<input type="text" name="smtp_user" class="form-control" value="<?php echo isset($_POST['smtp_user']) ? e($_POST['smtp_user']) : $loginsystem->getMainData('smtp_user'); ?>" id="smtp_user" maxlength="128" placeholder="user@nfsmw15.de">
								</div>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="form-group">
											<?php /* Summernote-HTML-Editor: Inhalte werden bewusst als HTML ausgegeben. Eingabe erfolgt nur durch Admins mit mainsave-Recht. */ ?>
