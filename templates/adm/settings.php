							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										...
										<input type="text" name="title" require class="form-control" value="<?php echo e(isset($_POST['title']) ? $_POST['title'] : $loginsystem->getMainData('site_title')); ?>" id="title" maxlength="64" placeholder="Seitentitel">
									</div>
								</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										<span class="input-group-addon"><i class="fa fa-fw fa-font fa-fw"></i></span>
										<input type="text" name="title_short" require class="form-control" value="<?php echo e(isset($_POST['title_short']) ? $_POST['title_short'] : $loginsystem->getMainData('short_site_title')); ?>" id="title_short" maxlength="16" placeholder="Seitentitel (kurz)">
									</div>
								</div>
								<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										...
										<input type="email" name="email" require class="form-control" value="<?php echo e(isset($_POST['email']) ? $_POST['email'] : $loginsystem->getMainData('administrator_mail')); ?>" id="email" maxlength="128" placeholder="Administrator E-Mail">
									</div>
								</div>
								<div class="col-sm-6">
						...
						<div class="form-group">
  							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										<span class="input-group-addon"><i class="fa fa-fw fa-envelope fa-fw"></i></span>
										<input type="email" name="from" require class="form-control" value="<?php echo e(isset($_POST['from']) ? $_POST['from'] : $loginsystem->getMainData('mail_sender')); ?>" id="from" maxlength="128" placeholder="Sender E-Mail">
									</div>
 								</div>
								<div class="col-sm-6"><br>
                        ...
                        <div class="form-group">
  							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										<span class="input-group-addon"><i class="fa fa-fw fa-envelope fa-fw"></i></span>
										<input type="email" name="to" require class="form-control" value="<?php echo e(isset($_POST['to']) ? $_POST['to'] : $loginsystem->getMainData('mail_receiver')); ?>" id="to" maxlength="128" placeholder="Empf&auml;nger E-Mail">
									</div>
 								</div>
								<div class="col-sm-6"><br>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									...
									<input type="text" name="smtp_host" class="form-control" value="<?php echo e(isset($_POST['smtp_host']) ? $_POST['smtp_host'] : $loginsystem->getMainData('smtp_host')); ?>" id="smtp_host" maxlength="128" placeholder="z.B. mail.nfsmw15.de">
								</div>
								<div class="col-sm-2">
									<label for="smtp_port">Port:</label>
									<input type="number" name="smtp_port" class="form-control" value="<?php echo e(isset($_POST['smtp_port']) ? $_POST['smtp_port'] : $loginsystem->getMainData('smtp_port')); ?>" id="smtp_port" placeholder="587">
								</div>
								<div class="col-sm-3">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									...
									<input type="text" name="smtp_user" class="form-control" value="<?php echo e(isset($_POST['smtp_user']) ? $_POST['smtp_user'] : $loginsystem->getMainData('smtp_user')); ?>" id="smtp_user" maxlength="128" placeholder="user@nfsmw15.de">
								</div>
								<div class="col-sm-4">
									<label for="smtp_pass">SMTP Passwort:</label>
									<input type="password" name="smtp_pass" class="form-control" value="" id="smtp_pass" maxlength="256" placeholder="leer lassen = unverändert">
								</div>
							</div>
						</div>
 						<hr>
							<div class="form-group">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group input-group">
											<span class="input-group-addon"><i class="fa fa-fw fa-envelope fa-fw"></i></span>
											<input type="email" name="dsgvo" require class="form-control" value="<?php echo e(isset($_POST['dsgvo']) ? $_POST['dsgvo'] : $loginsystem->getMainData('dsgvo_email')); ?>" id="dsgvo" maxlength="128" placeholder="E-Mail f&uuml;r Datenschutz">
										</div>
									</div>
									<div class="col-sm-6"><br>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											<textarea name="impressum_info" id="impressum_info" class="form-control" rows="6"><?php echo e(isset($_POST['impressum_info']) ? $_POST['impressum_info'] : $loginsystem->getMainData('impressum_info')); ?></textarea>
										</div>
									</div>
									<div class="col-sm-6"><br>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										...
										<input type="number" class="form-control" id="pwlength" name="pwlength" placeholder="PW min. length" min="3" max="32" maxlength="2" value="<?php echo e(isset($_POST['pwlength']) ? $_POST['pwlength'] : $loginsystem->getMainData('password_length')); ?>">
									</div>
								</div>
								<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group input-group">
										...
										<input type="number" class="form-control" id="cookie_lifetime" name="cookie_lifetime" placeholder="Zeit in Sekunden" min="86400" max="9999999999999999" maxlength="16" value="<?php echo e(isset($_POST['cookie_lifetime']) ? $_POST['cookie_lifetime'] : $loginsystem->getMainData('cookielifetime')); ?>">
									</div>
